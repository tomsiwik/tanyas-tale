...
class InputHandler {
  ...
  getDirection() {
    ...
    if (this.keyState.has("ArrowUp") || this.keyState.has("w"))
      dir |= Direction.UP;
    if (this.keyState.has("ArrowRight") || this.keyState.has("d"))
      dir |= Direction.RIGHT;
    if (this.keyState.has("ArrowDown") || this.keyState.has("s"))
      dir |= Direction.DOWN;
    if (this.keyState.has("ArrowLeft") || this.keyState.has("a"))
      dir |= Direction.LEFT;
